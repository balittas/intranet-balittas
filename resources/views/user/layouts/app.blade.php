...
<style>
    .sub-submenu{
      margin-top: 0; /* Adjust the spacing between submenus */
      left: 100%; /* Position sub-submenus to the right */
    }
</style>
   <header>
    <!-- Header Start -->
                   ...
                   <div class="col-xl-12">
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="header-info-left">
                                <ul>
                                    <li><img src="{{asset('assets/frontend/img/icon/header_icon1.png')}}" alt="">34ºc, Sunny </li>
                                    <li><img src="{{asset('assets/frontend/img/icon/header_icon1.png')}}" alt="">Tuesday, 18th June, 2019</li>
                                </ul>
                            </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 header-flex">
                            <!-- sticky -->
                                <div class="sticky-logo">
                                    <a href="{{ route('artikel') }}"><img src="{{asset('assets/admin/img/logo/logo.png')}}" width="200px"></a>
                                </div>
                            <!-- Main-menu -->
...
<!-- JS here -->
        ...
        <script src="{{asset('assets/frontend/js/site.js')}}"></script>
