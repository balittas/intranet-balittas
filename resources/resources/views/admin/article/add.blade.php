    ...
    <div class="col-sm-12" style="margin-bottom:20%">
        <div class="card">
            <div class="box-body" style="padding-bottom:50px">
                <form id="fileUploadForm" class="text-left border border-light p-5" action="{{route('article.store')}}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="konten" class="form-control html-editor" rows="5"></textarea>
                    </div>
