...
<head>
    ...
    <link rel="stylesheet" href="{{url('assets/admin/plugins/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css')}}">
            ...
            <div class="app-sidebar colored">
                <div class="sidebar-header">
                    <a class="header-brand" href="#">
                        <div class="logo-img">
                            <img src="{{url('assets/admin/img/logo/logo.png')}}" class="header-brand-img"
                                alt="lavalite" width="500%">
                        </div>
                    </a>
                ...
                <div class="sidebar-content">
                    <div class="nav-container">
                        <nav id="main-menu-navigation" class="navigation-main">
                            ...
                            <div
                                class="nav-item has-sub {{Route::is('dokumen.index') || Route::is('dokumen.create') || Route::is('dokumen.edit') || Route::is('kategori.index') || Route::is('kategori.create') || Route::is('kategori.edit') || Route::is('dokumen_rdhp.index') || Route::is('dokumen_rdhp.create') || Route::is('dokumen_rdhps.edit') || Route::is('dokumen_rptp.index') || Route::is('dokumen_rptp.create') || Route::is('dokumen_rptp.edit')  ? 'open' : ''}}">
                                <a href="javascript:void(0)"><i class="mdi mdi-note-multiple"></i><span> Dokumen Master Data</span></a>
                                <div class="submenu-content">
                                    <a href="{{route('article.index')}}" class="menu-item {{Route::is('article.index') || Route::is('article.create') || Route::is('article.edit')  ? 'active' : ''}}"><i class="mdi mdi-note"></i> Artikel</a>
                                </div>
                                <div class="submenu-content ">
                                    <a href="{{route('kategori_artikel.index')}}" class="menu-item {{Route::is('kategori_artikel.index') || Route::is('kategori_artikel.create') || Route::is('kategori_artikel.edit')  ? 'active' : ''}}"><i class="mdi mdi-note"></i> Kategori Artikel</a>
                                </div>
                                <div class="submenu-content">
                                    <a href="{{route('dokumen.index')}}" class="menu-item {{Route::is('dokumen.index') || Route::is('dokumen.create') || Route::is('dokumen.edit')  ? 'active' : ''}}"><i class="mdi mdi-note"></i> Dokumen</a>
                                </div>
                                <div class="submenu-content ">
                                    <a href="{{route('kategori.index')}}" class="menu-item {{Route::is('kategori.index') || Route::is('kategori.create') || Route::is('kategori.edit')  ? 'active' : ''}}"><i class="mdi mdi-note"></i> Kategori Dokumen</a>
                                </div>
                                <div class="submenu-content ">
                                    <a href="{{route('dokumen_rdhp.index')}}" class="menu-item {{Route::is('dokumen_rdhp.index') || Route::is('dokumen_rdhp.create') || Route::is('dokumen_rdhp.edit')  ? 'active' : ''}}"><i class="mdi mdi-note "></i> RDHP</a>
                                </div>
                                <div class="submenu-content ">
                                    <a href="{{route('dokumen_rptp.index')}}" class="menu-item {{Route::is('dokumen_rptp.index') || Route::is('dokumen_rptp.create') || Route::is('dokumen_rptp.edit')  ? 'active' : ''}}"><i class="mdi mdi-note "></i> RPTP</a>
                                </div>
                                <div class="submenu-content ">
                                    <a href="{{route('sk.index')}}" class="menu-item {{Route::is('sk.index') || Route::is('sk.create') || Route::is('sk.edit')  ? 'active' : ''}}"><i class="mdi mdi-note "></i> Surat Keputusan</a>
                                </div>
                            </div>
                            <div
                                class="nav-item">
                                <a href="{{route('user.index')}}"><i class="mdi mdi-account"></i>
                                    <span>Users</span></a>
                            </div>
                        </nav>
                    </div>
