                    ...
                    <div class="card-body">
                        <div class="dt-responsive">
                            ...
                            <table id="dataTable" class="table table-striped table-bordered nowrap" style="width: 102%">
                                ...
                                <tbody>
                                    @foreach($rptp as $rptp)
                                    <tr>
                                        <td>
                                            <span>{{ $rptp -> judul}}</span>
                                        </td>
                                        <td>
                                            <span>{{ $rptp -> penanggung_jawab}}</span>
                                        </td>
                                        <td>
                                        <span><a href="{{ $rptp -> dokumen_file}}" style="color: blue;"><button class="btn" style="background-color: DodgerBlue;
                                            border: none;
                                            color: white;
                                            padding: 12px;
                                            cursor: pointer;
